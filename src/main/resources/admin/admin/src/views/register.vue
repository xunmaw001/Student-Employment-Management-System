  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='fudaoyuan'">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='fudaoyuan'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='fudaoyuan'">
			...
			<el-form-item label="学院" class="input" v-if="tableName=='fudaoyuan'">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='fudaoyuan'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='fudaoyuan'">
			...
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			   <div class="label">企业号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qiyehao" class="input" type="text" placeholder="企业号">
			   </div>
			 </div> -->
			<el-form-item label="企业号" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.qiyehao" autocomplete="off" placeholder="企业号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.gonghao) && `fudaoyuan` == this.tableName){
      ...
      if((!this.ruleForm.xingming) && `fudaoyuan` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
      if(`fudaoyuan` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
      if(`fudaoyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
      ...
      if((!this.ruleForm.qiyehao) && `qiye` == this.tableName){

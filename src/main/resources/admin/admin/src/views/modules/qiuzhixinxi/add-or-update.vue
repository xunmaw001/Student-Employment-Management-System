      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教育背景" prop="jiaoyubeijing">
          <el-input v-model="ruleForm.jiaoyubeijing" 
              placeholder="教育背景" clearable  :readonly="ro.jiaoyubeijing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教育背景" prop="jiaoyubeijing">
              <el-input v-model="ruleForm.jiaoyubeijing" 
                placeholder="教育背景" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="获奖证书" prop="huojiangzhengshu">
          <el-input v-model="ruleForm.huojiangzhengshu" 
              placeholder="获奖证书" clearable  :readonly="ro.huojiangzhengshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="获奖证书" prop="huojiangzhengshu">
              <el-input v-model="ruleForm.huojiangzhengshu" 
                placeholder="获奖证书" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../springboothch86/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

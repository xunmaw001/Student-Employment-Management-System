    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="通知内容" prop="tongzhineirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tongzhineirong" label="通知内容" prop="tongzhineirong">
                    <span v-html="ruleForm.tongzhineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tongzhineirong = this.ruleForm.tongzhineirong.replace(reg,'../../../springboothch86/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

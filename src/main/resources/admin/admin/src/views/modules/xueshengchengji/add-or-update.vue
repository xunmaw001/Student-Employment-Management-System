<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级排名" prop="banjipaiming">
          <el-input v-model="ruleForm.banjipaiming" 
              placeholder="班级排名" clearable  :readonly="ro.banjipaiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级排名" prop="banjipaiming">
              <el-input v-model="ruleForm.banjipaiming" 
                placeholder="班级排名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      this.$http({
		...
		if(json.gonghao!=''&&json.gonghao){
          ...
          this.$message.error(data.msg);
            ...
            this.shifouhegeOptions = "是,否".split(',')
    },
    // 下二随
    xuehaoChange () {
      this.$http({

    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '年份' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.nianfen" placeholder="年份" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.nianfen" placeholder="年份" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.nianfen" placeholder="年份" clearable></el-input>
                </el-form-item>
		<el-form-item class="select" label="学期" prop="xueqi">
...
//导出excel
  ...
  methods: {
    ...
    init () {
          ...
          let urlfenshu = 'xueshengchengji/remind/fenshu/1';
		urlfenshu+=`?remindend=61`,
		
            	urlfenshu+=`&remindstart=0`,
          ...
          this.$http({
            ...
            if (data && data.code == 0 && data.count>0 ) {
              this.$alert(`分数有${data.count}条记录到达预警`)
            }
          });
    },
    search() {

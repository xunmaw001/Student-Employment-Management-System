<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="企业号" prop="qiyehao">
          <el-input v-model="ruleForm.qiyehao" 
              placeholder="企业号" clearable  :readonly="ro.qiyehao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="企业号" prop="qiyehao">
              <el-input v-model="ruleForm.qiyehao" 
                placeholder="企业号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="工作类型" prop="gongzuoleixing">
        ...
        <div v-else>
          <el-form-item class="input" label="工作类型" prop="gongzuoleixing">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="职位要求" prop="zhiweiyaoqiu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhiweiyaoqiu" label="职位要求" prop="zhiweiyaoqiu">
                    <span v-html="ruleForm.zhiweiyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工资待遇" prop="gongzidaiyu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongzidaiyu" label="工资待遇" prop="gongzidaiyu">
                    <span v-html="ruleForm.gongzidaiyu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工作地点" prop="gongzuodidian">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuodidian" label="工作地点" prop="gongzuodidian">
                    <span v-html="ruleForm.gongzuodidian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='qiyehao'){
            this.ruleForm.qiyehao = obj[o];
	    this.ro.qiyehao = true;
            continue;
          }
          if(o=='qiyemingcheng'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.qiyehao!=''&&json.qiyehao){
                this.ruleForm.qiyehao = json.qiyehao
	    		this.ro.qiyehao = true;
		}
	...
	this.ruleForm.zhiweiyaoqiu = this.ruleForm.zhiweiyaoqiu.replace(reg,'../../../springboothch86/upload');
	this.ruleForm.gongzidaiyu = this.ruleForm.gongzidaiyu.replace(reg,'../../../springboothch86/upload');
	this.ruleForm.gongzuodidian = this.ruleForm.gongzuodidian.replace(reg,'../../../springboothch86/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qiyezhaopin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qiyezhaopinCrossAddOrUpdateFlag = false;
						 this.parent.search();

...
public class QiuzhixinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,QiuzhixinxiEntity qiuzhixinxi,
		...
		if(tableName.equals("xuesheng")) {
			qiuzhixinxi.setXuehao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		qiuzhixinxi.setClicknum(qiuzhixinxi.getClicknum()+1);
		qiuzhixinxi.setClicktime(new Date());
    ...
    public R autoSort(@RequestParam Map<String, Object> params,QiuzhixinxiEntity qiuzhixinxi, HttpServletRequest request,String pre){
        EntityWrapper<QiuzhixinxiEntity> ew = new EntityWrapper<QiuzhixinxiEntity>();
